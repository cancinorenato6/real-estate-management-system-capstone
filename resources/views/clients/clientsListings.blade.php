                            ...
                            <div class="col-md-9">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <form method="POST" action="{{ route('favoriteProperty', $property->id) }}" class="favorite-form">
                                            ...
                                            <button type="submit" class="btn btn-light p-1 favorite-btn">
                                                <i class="bi {{ $property->favoredBy->contains(Auth::guard('client')->id()) ? 'bi-heart-fill' : 'bi-heart' }}" style="font-size: 1.2rem; color: red;"></i>
                                            </button>
                                        </form>
                                    </div>
                                    <div class="d-flex mt-2">
                                        ...
                                        <a href="{{ route('clientsViewProperties', $property->id) }}" class="btn btn-outline-primary ms-auto align-self-end">
                                            <i class="bi bi-info-circle me-1"></i> View Details
                                        </a>
                                    </div>
                                </div>
 ...
 */
function setupCardHoverEffects() {
    // Add hover animation for property images
    document.querySelectorAll('.property-image-container img').forEach(img => {
        img.addEventListener('mouseenter', function() {
            this.style.transform = 'scale(1.05)';
        });
